    ...
    <div className="min-h-screen flex items-center justify-center bg-[#010d1e] stripe-bg px-4 py-12 relative overflow-hidden">
      ...
      <div className="w-full max-w-md z-10">
        <div className="text-center mb-10 fade-up visible">
          ...
          <h2 className="text-4xl font-light text-white mb-3" style={{ fontFamily: 'var(--font-primary)' }}>Welcome Back</h2>
          <p className="text-white/60 font-medium" style={{ fontFamily: 'var(--font-secondary)' }}>Sign in to continue your journey</p>
        </div>
        ...
        <div className="bg-white/5 backdrop-blur-xl border border-white/10 p-8 sm:p-10 rounded-2xl shadow-2xl relative glow-border">
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="text-center mt-6 pt-4 border-t border-white/10">
               <span className="text-white/50 text-sm font-secondary mr-2">Don't have an account?</span>
               <Link href="/register" className="text-[#6c7ee6] hover:text-[#8b9bf0] text-sm font-semibold transition-colors font-secondary">
                 Join now
               </Link>
            </div>
          </form>
